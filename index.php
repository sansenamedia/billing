<?php
 ...
 if ($_SESSION['admin'] || $_SESSION['user'] || $_SESSION['kasir']) {
...
<div class="wrapper">
 ...
 ?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php date("Y"); ?> <a href="https://www.jagodigital.web.id/" target="_blank">Jagodigital.web.id</a>.</strong> All rights
    reserved.
  </footer>
